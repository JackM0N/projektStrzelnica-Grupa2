...
-- Started on 2024-04-15 17:02:09
...
--
-- TOC entry 245 (class 1259 OID 114689)
-- Name: webcontent; Type: TABLE; Schema: public; Owner: strzelnica_db_owner
--

CREATE TABLE public.webcontent (
    id bigint NOT NULL,
    contents text NOT NULL
);


ALTER TABLE public.webcontent OWNER TO strzelnica_db_owner;

--
-- TOC entry 244 (class 1259 OID 114688)
-- Name: webcontent_id_seq; Type: SEQUENCE; Schema: public; Owner: strzelnica_db_owner
--

ALTER TABLE public.webcontent ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.webcontent_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 3265 (class 2604 OID 73773)
...
--
-- TOC entry 3272 (class 2604 OID 81973)
...
--
-- TOC entry 3266 (class 2604 OID 81924)
...
--
-- TOC entry 3267 (class 2604 OID 81932)
...
--
-- TOC entry 3264 (class 2604 OID 73766)
...
--
-- TOC entry 3273 (class 2604 OID 81985)
...
--
-- TOC entry 3274 (class 2604 OID 90121)
...
--
-- TOC entry 3263 (class 2604 OID 73754)
...
--
-- TOC entry 3262 (class 2604 OID 90150)
...
--
-- TOC entry 3268 (class 2604 OID 81956)
...
--
-- TOC entry 3491 (class 0 OID 73770)
-- Dependencies: 224
...
--
-- TOC entry 3501 (class 0 OID 81970)
-- Dependencies: 234
...
--
-- TOC entry 3493 (class 0 OID 81921)
-- Dependencies: 226
...
--
-- TOC entry 3495 (class 0 OID 81929)
-- Dependencies: 228
...
--
-- TOC entry 3483 (class 0 OID 49179)
-- Dependencies: 216
...
INSERT INTO public.news OVERRIDING SYSTEM VALUE VALUES (104, 'deprecation test 1', 'test', '2024-04-08', 0, 'test', false);
INSERT INTO public.news OVERRIDING SYSTEM VALUE VALUES (14, 'ABC2', 'https://cdn.onemars.net/sites/perfect-fit_pl_W7ZCj_JAs8/image/large_kot-nie-chce-jeoe-mokrej-karmy-sprawdc-czy-powinieneo-si-r-przejmowae_1637151639646_1686300799201.png', '2024-04-13', 1, 'ABC3', false);
...
--
-- TOC entry 3489 (class 0 OID 73763)
-- Dependencies: 222
...
--
-- TOC entry 3505 (class 0 OID 82018)
-- Dependencies: 238
...
--
-- TOC entry 3506 (class 0 OID 82043)
-- Dependencies: 239
...
--
-- TOC entry 3496 (class 0 OID 81942)
-- Dependencies: 229
...
--
-- TOC entry 3503 (class 0 OID 81982)
-- Dependencies: 236
...
--
-- TOC entry 3504 (class 0 OID 81998)
-- Dependencies: 237
...
--
-- TOC entry 3487 (class 0 OID 73751)
-- Dependencies: 220
...
--
-- TOC entry 3485 (class 0 OID 73729)
-- Dependencies: 218
...
INSERT INTO public.users VALUES (0, 'Testowy', 'test', '', 'brrrr@email.email', '2024-04-01', true);


--
-- TOC entry 3499 (class 0 OID 81959)
-- Dependencies: 232
...
INSERT INTO public.weapon OVERRIDING SYSTEM VALUE VALUES (31, 'asd', 0, 0, false, '$0.00', false, 'asd');
INSERT INTO public.weapon OVERRIDING SYSTEM VALUE VALUES (1, 'M4 Carbine 2', 50, 100, true, '$50.00', false, 'M4-1234');
INSERT INTO public.weapon OVERRIDING SYSTEM VALUE VALUES (5, 'M1911', 90, 80, false, '$25.00', false, 'M1911-151617');


--
-- TOC entry 3498 (class 0 OID 81953)
-- Dependencies: 231
...
-- Dependencies: 245
-- Data for Name: webcontent; Type: TABLE DATA; Schema: public; Owner: strzelnica_db_owner
--
...
SELECT pg_catalog.setval('public.news_id_seq', 104, true);
...
SELECT pg_catalog.setval('public.weapon_id_seq', 31, true);


--
-- TOC entry 3543 (class 0 OID 0)
-- Dependencies: 244
-- Name: webcontent_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strzelnica_db_owner
--

SELECT pg_catalog.setval('public.webcontent_id_seq', 1, false);


--
-- TOC entry 3294 (class 2606 OID 73777)
...
--
-- TOC entry 3306 (class 2606 OID 81975)
...
--
-- TOC entry 3296 (class 2606 OID 81926)
...
--
-- TOC entry 3298 (class 2606 OID 81934)
...
--
-- TOC entry 3302 (class 2606 OID 81958)
...
--
-- TOC entry 3286 (class 2606 OID 49183)
...
--
-- TOC entry 3292 (class 2606 OID 73768)
...
--
-- TOC entry 3312 (class 2606 OID 82022)
...
--
-- TOC entry 3314 (class 2606 OID 82047)
...
--
-- TOC entry 3300 (class 2606 OID 81946)
...
--
-- TOC entry 3308 (class 2606 OID 81987)
...
--
-- TOC entry 3310 (class 2606 OID 82002)
...
--
-- TOC entry 3288 (class 2606 OID 90152)
...
--
-- TOC entry 3290 (class 2606 OID 73756)
...
--
-- TOC entry 3304 (class 2606 OID 81963)
...
--
-- TOC entry 3320 (class 2606 OID 114695)
-- Name: webcontent webcontent_pkey; Type: CONSTRAINT; Schema: public; Owner: strzelnica_db_owner
--

ALTER TABLE ONLY public.webcontent
    ADD CONSTRAINT webcontent_pkey PRIMARY KEY (id);


--
-- TOC entry 3321 (class 2606 OID 90153)
...
--
-- TOC entry 3331 (class 2606 OID 82073)
...
--
-- TOC entry 3332 (class 2606 OID 82078)
...
--
-- TOC entry 3326 (class 2606 OID 82013)
...
--
-- TOC entry 3327 (class 2606 OID 90163)
...
--
-- TOC entry 3336 (class 2606 OID 90188)
...
--
-- TOC entry 3324 (class 2606 OID 82038)
...
--
-- TOC entry 3325 (class 2606 OID 90173)
...
--
-- TOC entry 3335 (class 2606 OID 82048)
...
--
-- TOC entry 3328 (class 2606 OID 82003)
...
--
-- TOC entry 3333 (class 2606 OID 81993)
...
--
-- TOC entry 3334 (class 2606 OID 90158)
...
--
-- TOC entry 3337 (class 2606 OID 90124)
...
--
-- TOC entry 3338 (class 2606 OID 90183)
...
--
-- TOC entry 3322 (class 2606 OID 82023)
...
--
-- TOC entry 3323 (class 2606 OID 90168)
...
--
-- TOC entry 3329 (class 2606 OID 90178)
...
--
-- TOC entry 3330 (class 2606 OID 82053)
...
--
-- TOC entry 2119 (class 826 OID 32769)
...
--
-- TOC entry 2118 (class 826 OID 32768)
...
-- Completed on 2024-04-15 17:02:17
